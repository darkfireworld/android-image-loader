 ...
 * *****************************************************************************
 */
package org.darkgem.imageloader.vendor.support.grab.http.disk;
...
public interface DiskCache {
     ...
     * @param listener    Listener for saving progress, can be ignored if you don't use in ImageLoader calls
     * @return <b>true</b> - if image was saved successfully; <b>false</b> - if image wasn't saved in disk cache.
     * @throws IOException
     */
    boolean save(String imageUri, InputStream imageStream, IoUtil.CopyListener listener) throws IOException;
